...
export const SLOT_TO_PLACE_TYPES: Record<string, string[]> = {
  ...
  tourism: ["tourism", "museum", "art_gallery", "viewpoint", "picnic_site", "camp_site", "theme_park"],
  shop: ["shop", "mall", "clothes", "gift", "toys", "books", "electronics"],
  sport: ["sport", "tennis", "golf", "fitness", "yoga"],
  historic: ["historic"],
